        ...
        <section id="education">
          <div className="flex min-h-0 min-w-[60vw] w-full flex-col gap-y-3">
            <BlurFade delay={BLUR_FADE_DELAY * 7}>
              <h2 className="text-xl font-bold">Team / Divisi</h2>
            </BlurFade>
            ...
            <div className="flex flex-wrap gap-1 items-center justify-center">
              {DATA.skills.map((skill, id) => (
                ...
                >
                  <Badge
                    key={skill.name}
                    className={`hover:cursor-default transition-all duration-300 ease-in-out ${skill.name === "Documentation" ? "hover:bg-[#FF1F5E] hover:text-white" : ""}`}
                  >
